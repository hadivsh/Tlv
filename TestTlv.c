...
int main() {
    ...
    TLV *tlv_80 = tlv_create(0x80, val1, strlen(val1));
    tlv_add_sub_tlv(rootC0, tlv_80);

    TLV *tlv_D1 = tlv_create_container(0xD1);
    TLV *tlv_D1_80 = tlv_create(0x80, val2,strlen(val2));
    TLV *tlv_D1_81 = tlv_create(0x81, val3, strlen(val3));
    ...
    size_t packed_len = tlv_pack(rootFF, buffer);
